...
//	}
	...
	@Autowired
	public PasswordUpdateController(EmployeeService employeeService) {
	...
	public String updatePassword(@ModelAttribute PasswordDto dto, Model model, HttpSession session, HttpServletRequest request) {

		boolean updateStatus = employeeService.updatePassword(dto);

		if (updateStatus) {

			session.invalidate();
			session = request.getSession(true);
			session.setAttribute("msg", "Password changed. Please login again.");
